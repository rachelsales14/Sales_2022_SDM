...
cloud=raster("cloudhelp21.tif")
aspect=raster("aspecthelp21.tif")
precip=raster("preciphelp21.tif")
dist=raster("distrivhelp21.tif")
dem=raster("demhelp41.tif")
tpi=raster("TPIhelp21.tif")
